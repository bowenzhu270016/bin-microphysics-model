...
if set1==1:
    ...
    runToDo = [[['tpert=0','winit=2.5','entrain_aerosol=.true.','release_aerosol=.true.','thresh_to_start_hom_mix=0.','hm_flag=.false.','break_flag=0','mode1_flag=.false.','mode2_flag=.false.'],\
                ['tpert=0.5','winit=1.5','entrain_aerosol=.true.','release_aerosol=.true.','thresh_to_start_hom_mix=0.','hm_flag=.true.','break_flag=2','mode1_flag=.true.','mode2_flag=.true.'],\
                ['tpert=0.75','winit=1.5','entrain_aerosol=.true.','release_aerosol=.true.','thresh_to_start_hom_mix=0.','hm_flag=.true.','break_flag=2','mode1_flag=.true.','mode2_flag=.true.'],\
                ['tpert=1.0','winit=1.5','entrain_aerosol=.true.','release_aerosol=.true.','thresh_to_start_hom_mix=0.','hm_flag=.true.','break_flag=2','mode1_flag=.true.','mode2_flag=.true.'],\
                ['tpert=1.25','winit=1.5','entrain_aerosol=.true.','release_aerosol=.true.','thresh_to_start_hom_mix=0.','hm_flag=.true.','break_flag=2','mode1_flag=.true.','mode2_flag=.true.'],\
                ['tpert=1.5','winit=1.5','entrain_aerosol=.true.','release_aerosol=.true.','thresh_to_start_hom_mix=0.','hm_flag=.true.','break_flag=2','mode1_flag=.true.','mode2_flag=.true.'],\
                ['tpert=1.75','winit=1.5','entrain_aerosol=.true.','release_aerosol=.true.','thresh_to_start_hom_mix=0.','hm_flag=.true.','break_flag=2','mode1_flag=.true.','mode2_flag=.true.'],\

                ['tpert=2','winit=1.5','entrain_aerosol=.true.','release_aerosol=.true.','thresh_to_start_hom_mix=0.','hm_flag=.true.','break_flag=2','mode1_flag=.true.','mode2_flag=.true.']]]
