...
if set1==1:
    ...
    runToDo = [[['updraft_type=4','ent_rate=0.2','thresh_to_start_hom_mix=0.','hm_flag=.false.','break_flag=0','mode1_flag=.false.','mode2_flag=.false.'],\
                ['updraft_type=4','ent_rate=0.2','thresh_to_start_hom_mix=0.','hm_flag=.true.','break_flag=2','mode1_flag=.true.','mode2_flag=.true.'],\
                ['updraft_type=4','ent_rate=0.2','thresh_to_start_hom_mix=8000.','hm_flag=.false.','break_flag=0','mode1_flag=.false.','mode2_flag=.false.'],\
                ['updraft_type=4','ent_rate=0.2','thresh_to_start_hom_mix=8000.','hm_flag=.true.','break_flag=2','mode1_flag=.true.','mode2_flag=.true.'],\
                ['updraft_type=2','ent_rate=0.0','thresh_to_start_hom_mix=0.','hm_flag=.false.','break_flag=0','mode1_flag=.false.','mode2_flag=.false.'],\

                ['updraft_type=2','ent_rate=0.0','thresh_to_start_hom_mix=0.','hm_flag=.true.','break_flag=2','mode1_flag=.true.','mode2_flag=.true.']]]
    columns1=['ent']

elif set1==6:
    runToDo = [[['hm_flag=.false.','break_flag=0','mode1_flag=.false.','mode2_flag=.false.'],\
                ...
                ['hm_flag=.true.','break_flag=2','mode1_flag=.true.','mode2_flag=.true.']]]
    columns1=['ent']

elif set1==7:
    runToDo = [[['thresh_to_start_hom_mix=0.','hm_flag=.false.','break_flag=0','mode1_flag=.false.','mode2_flag=.false.'],\
                
                ['thresh_to_start_hom_mix=0.','hm_flag=.true.','break_flag=0','mode1_flag=.false.','mode2_flag=.false.'],\
                ['thresh_to_start_hom_mix=0.','hm_flag=.false.','break_flag=2','mode1_flag=.false.','mode2_flag=.false.'],\
                ['thresh_to_start_hom_mix=0.','hm_flag=.false.','break_flag=0','mode1_flag=.true.','mode2_flag=.false.'],\
                ['thresh_to_start_hom_mix=0.','hm_flag=.false.','break_flag=0','mode1_flag=.false.','mode2_flag=.true.'],\
                    
                ['thresh_to_start_hom_mix=0.','hm_flag=.true.','break_flag=2','mode1_flag=.true.','mode2_flag=.true.'],\
                ...
                ['thresh_to_start_hom_mix=8000.','hm_flag=.false.','break_flag=0','mode1_flag=.false.','mode2_flag=.false.'],\

                ['thresh_to_start_hom_mix=8000.','hm_flag=.true.','break_flag=0','mode1_flag=.false.','mode2_flag=.false.'],\
                ['thresh_to_start_hom_mix=8000.','hm_flag=.false.','break_flag=2','mode1_flag=.false.','mode2_flag=.false.'],\
                ['thresh_to_start_hom_mix=8000.','hm_flag=.false.','break_flag=0','mode1_flag=.true.','mode2_flag=.false.'],\
                ['thresh_to_start_hom_mix=8000.','hm_flag=.false.','break_flag=0','mode1_flag=.false.','mode2_flag=.true.'],\
                    
               
                ['thresh_to_start_hom_mix=8000.','hm_flag=.true.','break_flag=2','mode1_flag=.true.','mode2_flag=.true.']]]
    columns1=['ent']
